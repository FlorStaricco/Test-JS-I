...
function redondearNumero(num) {
  ...
  // Tu código:
  let redondearNumero = Match.floor(Math.random()*100);
...
function agregarSimboloExclamacion(str) {
  ...
  let string2= "!";
  let agregarSimboloExclamacion = string1 + string2;
